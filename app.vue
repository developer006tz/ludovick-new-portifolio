      ...
      <div class="max-w-5xl mx-auto bg-white shadow-xl print:shadow-none print:max-w-full">
        ...
        <header class="flex flex-col md:flex-row px-8 pt-10 pb-8 relative print:flex-row print:pt-4 print:pb-4 print:px-4 bg-gradient-to-b from-gray-50 to-white">
          ...
          <div class="flex-grow text-center md:text-left md:pl-6 mt-12 md:mt-0 print:text-left print:pl-6 print:mt-0">
            <h1 class="text-3xl font-bold text-gray-900 tracking-tight print:text-2xl bg-clip-text text-transparent bg-gradient-to-r from-blue-800 to-indigo-700 mb-1">LUDOVICK KONYO</h1>
            <h2 class="text-xl font-semibold mb-3 print:text-lg print:mb-2 text-blue-600 tracking-wide">Software Developer</h2>
            ...
            <div class="flex justify-center md:justify-start space-x-4 mt-4 print:justify-start print:space-x-3 print:mt-2 print:text-xs">
              <a href="https://www.linkedin.com/in/ludovick-konyo-186504252/" class="text-blue-600 hover:text-blue-800 flex items-center print:no-underline bg-white py-1.5 px-3 rounded-md shadow-sm hover:shadow transition-all duration-200 border border-blue-100">
                <Icon name="uiw:linkedin" class="text-blue-500 w-5 h-4" />
                LinkedIn
              </a>
              <a href="https://github.com/developer006tz" class="text-blue-600 hover:text-blue-800 flex items-center print:no-underline bg-white py-1.5 px-3 rounded-md shadow-sm hover:shadow transition-all duration-200 border border-blue-100">
        ...
        <div class="px-8">
          ...
          <section class="mb-6">
            ...
            <div class="relative border-l-2 border-blue-200 pl-6 ml-3">
              ...
              <div class="mb-6 relative print:mt-0 print:pt-8 print:break-before-page">
                <div class="absolute w-4 h-4 bg-blue-600 rounded-full -left-8 top-1"></div>
                <div class="flex flex-col md:flex-row md:justify-between md:items-start mb-1">
                  <div>
          ...
          <section class="mb-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm mb-4">
              <div class="bg-white border border-blue-100 rounded-lg shadow-sm p-4 hover:shadow-md transition-shadow">
                ...
                <p class="text-gray-700 text-sm">Comprehensive shipping management system with secure authentication, tracking, and reporting features</p>
              </div>
              ...
              <div class="bg-white border border-blue-100 rounded-lg shadow-sm p-4 hover:shadow-md transition-shadow">
                ...
                <p class="text-gray-700 text-sm">Comprehensive platform for mining consultancy services in Tanzania and DRC with regulatory compliance tools, appointment scheduling, and resource management</p>
              </div>
              ...
              <div class="bg-white border border-blue-100 rounded-lg shadow-sm p-4 hover:shadow-md transition-shadow print:mt-0 print:pt-8 print:break-before-page">
                ...
                <p class="text-gray-700 text-sm">Professional healthcare platform for nursing home services, featuring patient management, wound care tracking, and home-based recovery support with doctor-directed care protocols</p>
              </div>
            </div>
          ...
          <section class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <div>
              ...
              <div class="bg-gray-50 p-4 rounded-lg border border-gray-100">
                <h4 class="font-semibold text-gray-900">Bachelor of Science in Information Technology</h4>
                <p class="text-blue-600 font-medium text-sm">National Insitute of Tansport (NIT)</p>
          ...
          <section class="mb-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 print:grid-cols-2">
              <div class="bg-gradient-to-r from-blue-50 to-indigo-50 p-4 rounded-lg border border-blue-100 shadow-sm transition-all hover:shadow">
                <div class="flex justify-between items-center mb-2">
                  <h4 class="font-semibold text-indigo-800">English</h4>
                ...
                <p class="text-sm text-gray-600 mt-2">Business communication, technical documentation, and professional presentations</p>
              </div>
              
              <div class="bg-gradient-to-r from-green-50 to-emerald-50 p-4 rounded-lg border border-green-100 shadow-sm transition-all hover:shadow">
                <div class="flex justify-between items-center mb-2">
                  <h4 class="font-semibold text-emerald-800">Swahili</h4>
                ...
                <p class="text-sm text-gray-600 mt-2">Complete fluency with cultural nuances, idioms, and professional terminology</p>
              </div>
            </div>
          </section>
        </div>
        ...
        <footer class="text-center py-4 px-8   bg-white">
        <h3 class="text-lg font-bold text-blue-800 mb-3 pb-1 border-b-2 border-blue-100 flex items-center">
          <Icon name="majesticons:users" class="text-blue-600 w-5 h-5 mr-2" />
                REFEREES
              </h3>
          <div class="grid grid-cols-1 md:grid-cols-2 gap-3 w-full print:grid-cols-2">
              <div class="bg-gray-50 rounded-lg p-2 border border-gray-100 flex items-center shadow-sm w-full">
                <div class="w-8 h-8 bg-blue-600 rounded-full flex items-center justify-center text-white font-bold mr-2 flex-shrink-0">EK</div>
                <div class="text-left">
                  <p class="font-medium text-md text-gray-800">Elisate Kanza</p>
                  <p class="text-md text-gray-600">Manager, Conveyance Logistics Limited</p>
                  <p class="text-md text-blue-600">info@conveyance.co.tz</p>
                </div>
              </div>
              <div class="bg-gray-50 rounded-lg p-2 border border-gray-100 flex items-center shadow-sm w-full">
                <div class="w-8 h-8 bg-blue-600 rounded-full flex items-center justify-center text-white font-bold mr-2 flex-shrink-0">PS</div>
                <div class="text-left">
                  <p class="font-medium text-md text-gray-800">Peter Sanga</p>
                  <p class="text-md text-gray-600">Clearing Officer, GPSA, Tanzania</p>
                  <p class="text-md text-blue-600">perersanga@gmail.com</p>
                </div>
              </div>
          </div>
